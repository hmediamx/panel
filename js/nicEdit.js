...
var nicEditorFontFormatSelect = nicEditorSelect.extend({
		sel : {'p' : 'Parrafo', 'h5' : 'CITE', 'h4' : 'EM', 'h3' : 'Balazos', 'h2' : 'Subtitulos'},
		
	init : function() {
		this.setDisplay('Dar&nbsp;formato...');
		for(itm in this.sel) {
...
var nicLinkButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		...
		this.addForm({
			'' : {type : 'title', txt : 'Añadir/Editar Enlace'},
			'href' : {type : 'text', txt : 'URL', value : 'http://', style : {width: '150px'}},
			'title' : {type : 'text', txt : 'Titulo'},
			'target' : {type : 'select', txt : 'Abrir en', options : {'' : 'la misma ventana', '_blank' : 'una nueva ventana'},style : {width : '100px'}}
		},this.ln);
	},
